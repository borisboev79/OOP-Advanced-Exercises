...
public class University {
    ...
    public String registerStudent(Student student) {
        ...
        if (getStudent(student.firstName, student.lastName) != null) {
            result = "StudentSytem.OOP.WorkingWithAbstraction_Exercise.Е05_JedyGalaxy.Student is already in the university";
        }
    ...
    public String dismissStudent(Student student) {
        ...
        if (foundStudent == null) {
            return "StudentSytem.OOP.WorkingWithAbstraction_Exercise.Е05_JedyGalaxy.Student not found";
        }
    ...
    public String getStatistics() {
        return students.stream()
                .map(s -> String.format(
                "==StudentSytem.OOP.WorkingWithAbstraction_Exercise.Е05_JedyGalaxy.Student: First Name = %s, Last Name = %s, Best Subject = %s",
