package OOP.InterfacesAndAbstraction_Exercise.E04_FoodShortage;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numberOfPeople; i++) {
            ...
            if(buyerParts.length == 3) {
                 ...
                 buyer = new Rebel(name, Integer.parseInt(buyerParts[1]), buyerParts[2]);
            } else {
                buyer = new Citizen(name, Integer.parseInt(buyerParts[1]), buyerParts[2], buyerParts[3]);
            }
